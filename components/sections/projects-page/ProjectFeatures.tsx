...
const ProjectFeatures = ({ features }: { features: features[] }) => {
  return (
    <section className="project-section-container">
      ...
      <ul className="w-full max-lg:max-w-[360px] mx-auto flex py-4 flex-col lg:flex-row gap-12 max-lg:gap-16">
        {features.map((featureCard) => (
          <li
            key={featureCard.label}
            className="max-lg:border-[0.5px] max-lg:border-[#cecece] cursor-pointer max-lg:shadow-lg shadow-xl rounded-xl p-4 overflow-hidden"
          >
            <ProjectFeatureCard
